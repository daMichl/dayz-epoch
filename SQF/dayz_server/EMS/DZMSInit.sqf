...
call compile preprocessFileLineNumbers "\z\addons\dayz_server\EMS\DZMSConfig.sqf";
waitUntil {DZMSConfigured};
DZMSConfigured = nil;

// These are Extended configuration files the user can adjust if wanted
call compile preprocessFileLineNumbers "\z\addons\dayz_server\EMS\ExtConfig\DZMSWeaponCrateList.sqf";
call compile preprocessFileLineNumbers "\z\addons\dayz_server\EMS\ExtConfig\DZMSAIConfig.sqf";
